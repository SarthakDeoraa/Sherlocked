...
import { UserCircle2, LogOut, Share2, PlayCircle, UsersIcon } from "lucide-react"
                ...
                <DropdownMenuContent align="end">
                  ...
                  {user.isTeamLeader && user.teamId && (
                    <>
                      ...
                      <DropdownMenuItem onClick={handleShare} className="flex items-center gap-2">
                        ...
                        {isInviteLoading ? "Loading..." : "Share Team Invite Code"}
                      </DropdownMenuItem>
                      <DropdownMenuItem asChild className="flex items-center gap-2">
                        <Link href="/play" className="flex items-center gap-2 w-full">
                  ...
                  {!user.teamId && (
                    <>
                      <DropdownMenuSeparator />
                      <DropdownMenuItem asChild className="flex items-center gap-2">
                        <Link href="/setup/join-team" className="flex items-center gap-2 w-full">
                          <UsersIcon className="w-4 h-4" /> Join Team
                        </Link>
                      </DropdownMenuItem>
                      <DropdownMenuItem asChild className="flex items-center gap-2">
                        <Link href="/setup/create-team" className="flex items-center gap-2 w-full">
