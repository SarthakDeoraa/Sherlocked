...
export default function SetupCreateTeam({ onSuccess }: { onSuccess?: () => void }) {
  ...
  const createTeamMutation = useMutation({
    mutationFn: async ({ name, description }: { name: string; description: string }) => {
      const res = await axios.post("/api/setup/create-team", { name, description });
      return res.data;
    },
    onSuccess: (data) => {
      setName("");
      ...
      toast.success("Your team has been created. Click profile to play or share team code.");
